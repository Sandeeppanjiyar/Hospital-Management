...
<br><a href="Request.html"><font size="2"><b><i>Home</i></b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Particular.html"><font size="2"><b><i>Back</i></b></font></a>
<%
    int flag=0,a=0;
    String DT=request.getParameter("dt");
    %>
    <p align="Center"><font color="red" size="4"><b>Feedbacks on: </b></font>
    <font color="blue" size="4"><b><%= DT%></b></font></p>
    <%
    ...
    ResultSet myResultSet=stmt.executeQuery("Select * from Feedback where Access_Date='"+DT+"'");
