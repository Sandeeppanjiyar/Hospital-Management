...
<p align="center"><font size="7" face="Lucida Calligraphy" color="brown"><b><u><i>Today's Enquiries</i></u></b></font></p>
</td></tr>
</table> 
<br><a href="Request.html"><font size="2"><b><i>Home</i></b></font></a>        
            ...
            ResultSet myResultSet=stmt.executeQuery("Select * from Enquiry where Access_Date='"+Date+"'"); 
            ...
            if(myResultSet!=null)
                {
                   while(myResultSet.next())
                    ...
                    {    
                     %>
                       <table align="center" border="2" width="2400" bordercolor="magenta">
                       <tr align="center">
