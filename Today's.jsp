...
<p align="center"><font size="7" face="Lucida Calligraphy" color="brown"><b><u><i>Today's Feedbacks</i></u></b></font></p>
</td></tr>
</table> 
<br><a href="Request.html"><font size="2"><b><i>Home</i></b></font></a>        
            ...
            %>
            <p align="Center"><font color="red" size="4"><b>Feedbacks on: </b></font>
            <font color="blue" size="4"><b><%= Date%> (Today)</b></font></p>
            <%
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            Connection myConn=DriverManager.getConnection("jdbc:odbc:Hospital");
            Statement stmt=myConn.createStatement();            
            ResultSet myResultSet=stmt.executeQuery("Select * from Feedback where Access_Date='"+Date+"'"); 
            ...
            if(myResultSet!=null)
                {
                   while(myResultSet.next())
                    ...
                    {    
                     %>
                     <table align="center" border="2" width="1500" bordercolor="magenta">
                     <tr align="center">
                     <td colspan="3"><b>NAME</b></td><td colspan="9"><b>ADDRESS</b></td><td colspan="2"><b>PHONE NO.</b></td><td colspan="2"><b>FAX NO.</b></td><td colspan="5"><b>EMAIL ID</b></td><td colspan="10"><b>COMMENTS</b></td><td colspan="3" ><b>IP ADDRESS</b></td><td colspan="2"><b>ACCESS DATE</b></td><td colspan="2"><b>ACCESS TIME</b></td></tr>    
                     <%
                     a=1;
                    } 
                  ...
                  {
                    %>
                     <p align="Center"><font size="6" color="red"><b><u><br>NO FEEDBACK!</u></b></font></p><br><br><br>      
                    <%
                  }
                  stmt.close();
                  myConn.close();
