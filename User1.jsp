...
<br><a href="Request.html"><font size="2"><b><i>Home</i></b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Client1.html"><font size="2"><b><i>Back</i></b></font></a>
<%
    int flag=0,a=0;
    ...
    ResultSet myResultSet=stmt.executeQuery("Select * from Enquiry where Name='"+UName+"'");
